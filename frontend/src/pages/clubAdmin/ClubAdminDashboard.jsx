...
export const ClubAdminDashboard = () => {
  ...
  React.useEffect(() => {
    fetch('http://localhost:5050/api/v1/clubs/club-1')
      .then((res) => res.json())
      .then((data) => {
        console.log('📡 [Club Admin Flow API Call]:', data);
      })
      .catch((err) => console.warn('Failed fetching club admin API:', err.message));
  }, []);
